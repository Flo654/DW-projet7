<template>
    <div class="create-message-card">
        <div class="create-message-card-header">
            ...
            <button class="create-message-card-header__button is-active">Modifier</button>
        </div>
        ...
        <div class="create-message-card-content">
            <textarea cols="32" rows="20" placeholder="Ecrivez votre message ici ...." >Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident iure quaerat distinctio autem? Magni voluptatibus vitae fugit, inventore repudiandae ipsa debitis iste, minima voluptas rem facere blanditiis nulla dolorem modi? Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nostrum commodi ratione nisi earum quae, sed placeat in nesciunt molestias itaque, maiores saepe quidem mollitia rerum fuga amet. Neque, ex accusantium.</textarea>
        </div>
